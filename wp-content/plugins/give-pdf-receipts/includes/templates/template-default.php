...
function give_pdf_template_default( $give_pdf, $give_pdf_payment, $give_pdf_payment_meta, $give_pdf_buyer_info, $give_pdf_payment_gateway, $give_pdf_payment_method, $address_line_2_line_height, $company_name, $give_pdf_payment_date, $give_pdf_payment_status ) {
	...
	$give_pdf->SetY( 45 );
	$give_pdf->Cell( 0, 0, __( 'Donation Receipt', 'give-pdf-receipts' ), 0, 2, 'L', false );

	$give_pdf->SetXY( 8, 60 );
	$give_pdf->SetFont( $font, 'B', 10 );
	$give_pdf->Cell( 0, 6, __( 'From', 'give-pdf-receipts' ), 0, 2, 'L', false );
	...
	$give_pdf->SetFont( $font, 'B', 10 );
	$give_pdf->Cell( 0, 6, __( 'To', 'give-pdf-receipts' ), 0, 2, 'L', false );
	$give_pdf->SetFont( $font, '', 10 );
	...
	$give_pdf->Cell( 30, 6, __( 'Receipt Date', 'give-pdf-receipts' ), 0, 0, 'L', false );
	$give_pdf->SetTextColor( 50, 50, 50 );
	...
	$give_pdf->SetTextColor( 110, 110, 110 );
	$give_pdf->Cell( 30, 6, __( 'Receipt ID', 'give-pdf-receipts' ), 0, 0, 'L', false );
	$give_pdf->SetTextColor( 50, 50, 50 );
	$give_pdf->Cell( 0, 6, give_pdf_get_payment_number( $give_pdf_payment->ID ), 0, 2, 'L', false );
	$give_pdf->SetX( 60 );
	$give_pdf->SetTextColor( 110, 110, 110 );
	$give_pdf->Cell( 30, 6, __( 'Transaction Key', 'give-pdf-receipts' ), 0, 0, 'L', false );
	$give_pdf->SetTextColor( 50, 50, 50 );
	$give_pdf->Cell( 0, 6, $give_pdf_payment_meta['key'], 0, 2, 'L', false );
	$give_pdf->SetX( 60 );
	$give_pdf->SetTextColor( 110, 110, 110 );
	$give_pdf->Cell( 30, 6, __( 'Donation Status', 'give-pdf-receipts' ), 0, 0, 'L', false );
	$give_pdf->SetTextColor( 50, 50, 50 );
	$give_pdf->Cell( 0, 6, $give_pdf_payment_status, 0, 2, 'L', false );
	$give_pdf->SetX( 60 );
	$give_pdf->SetTextColor( 110, 110, 110 );
	$give_pdf->Cell( 30, 6, __( 'Payment Method', 'give-pdf-receipts' ), 0, 0, 'L', false );
	$give_pdf->SetTextColor( 50, 50, 50 );
	...
	$give_pdf->SetFont( $font, 'B', 10 );
	$give_pdf->Cell( 140, 8, __( 'Receipt Items', 'give-pdf-receipts' ), 1, 2, 'C', true );
	...
	$give_pdf->Cell( 102, 7, __( 'Donation Name', 'give-pdf-receipts' ), 'BL', 0, 'C', false );
	$give_pdf->Cell( 38, 7, __( 'Donation Total', 'give-pdf-receipts' ), 'BR', 0, 'C', false );
	...
	if ( $give_pdf_payment_meta ) :
		...
		$give_pdf->SetDrawColor( 209, 209, 209 );
		$give_pdf->SetFont( $font, 'B', 10 );
		$give_pdf->Cell( 140, 8, __( 'Receipt Total', 'give-pdf-receipts' ), 1, 2, 'C', true );
		...
		$give_pdf->Cell( 102, 10, __( 'Total Donation', 'give-pdf-receipts' ), 'B', 0, 'L', false );
		...
		if ( isset( $give_options['give_pdf_additional_notes'] ) && ! empty ( $give_options['give_pdf_additional_notes'] ) ) {
			...
			$give_pdf->Cell( 0, 6, __( 'Additional Notes', 'give-pdf-receipts' ), 0, 2, 'L', false );
			$give_pdf->Ln( 2 );
