...
class Give_FFM_Admin_Template {
	...
	public static function common( $id, $field_name_value = '', $custom_field = true, $values = array(), $reqtoggle = true, $csstoggle = true ) {
		...
		<div class="give-form-fields-rows required-field wide">
			<label><?php _e( 'Required', 'give-form-field-manager' ); ?>
				<span class="give-tooltip give-icon give-icon-question"
				      data-tooltip="<?php _e( 'Is this a required field? Required fields must be completed prior to a donation.', 'give-form-field-manager' ); ?>"></span></label>

			<?php //self::hidden_field($order_name, ''); ?>
			<div class="give-form-fields-sub-fields">
				<label><input type="radio" name="<?php echo $required_name; ?>"
	...
	public static function common_text( $id, $values = array() ) {
		...
		<div class="give-form-fields-rows">
			<label><?php _e( 'Size', 'give-form-field-manager' ); ?>
				<span class="give-tooltip give-icon give-icon-question"
				      data-tooltip="<?php esc_attr_e( 'Size of this input field', 'give-form-field-manager' ); ?>"></label>
	...
	public static function common_textarea( $id, $values = array() ) {
		...
		?>
		<div class="give-form-fields-rows">
			<label><?php _e( 'Rows', 'give-form-field-manager' ); ?>
				<span class="give-tooltip give-icon give-icon-question"
				      data-tooltip="<?php _e( 'The number of rows in the textarea. This affects the height of the textarea.', 'give-form-field-manager' ); ?>"></label>
				...
				<div class="give-form-fields-rows wide">
					...
					<div class="give-form-fields-sub-fields">
						...
						<div class="description" style="margin-top: 8px;">
							<p class="cmb2-metabox-description"><?php _e( 'Sections are helpful to break up sections of a form.', 'give-form-field-manager' ); ?></p>
						</div>
					</div>
	...
	public static function dropdown_field( $field_id, $label, $values = array(), $removeable = true, $reqtoggle = true ) {
		...
		<li class="custom-field dropdown_field">
			...
			<div id="form-field-item-settings-<?php echo esc_attr( $field_id ); ?>"
				...
				<div class="give-form-fields-rows">
					<label><?php _e( 'Select Text', 'give-form-field-manager' ); ?>
						<span class="give-tooltip give-icon give-icon-question"
		...
		<li class="custom-field custom_repeater">
			...
			<div id="form-field-item-settings-<?php echo esc_attr( $field_id ); ?>"
				...
				<div class="give-form-fields-rows wide">
					<label><?php _e( 'Size', 'give-form-field-manager' ); ?>
						<span class="give-tooltip give-icon give-icon-question"
						      data-tooltip="<?php _e( 'Size of this input field.', 'give-form-field-manager' ); ?>"></span></label>
					<input type="text" name="<?php echo $size_name; ?>" value="<?php echo $size_value; ?>"/>
				</div>
				<!-- .give-form-fields-rows -->
...
function your_function_name( $form_id, $post_id, $form_settings ) {
	...
	public static function date_field( $field_id, $label, $values = array(), $removeable = true, $reqtoggle = true ) {
		...
		<li class="custom-field custom_image">
			...
			<div id="form-field-item-settings-<?php echo esc_attr( $field_id ); ?>"
				...
				<div class="give-form-fields-rows">
					<label><?php _e( 'Date Format', 'give-form-field-manager' ); ?>
						<span class="give-tooltip give-icon give-icon-question"
						      data-tooltip="<?php echo esc_attr( sprintf( __( 'The format of the date field. For help with formatting the date portion, visit the datepicker documentation for <a href="%1$s" target="_blank">formatting dates</a>.', 'give-form-field-manager' ), 'http://api.jqueryui.com/datepicker/' ) ); ?>"></span></label>
	 ...
	 * @param bool|true $reqtoggle
	 */
	public static function phone_field( $field_id, $label, $values = array(), $removeable = true, $reqtoggle = true ) {
		$tpl          = '%s[%d][%s]';
