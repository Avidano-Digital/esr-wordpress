...
class Give_FFM_Setup {
	...
	public function frontend_enqueue_scripts() {
		...
		if ( empty( $datepicker_css ) || $datepicker_css !== 'disabled' ) {
			wp_register_style( 'give_ffm_datepicker_styles', GIVE_FFM_PLUGIN_URL . 'assets/css/give-ffm-datepicker' . $this->suffix . '.css' );
		...
		if ( defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG ) {
			...
			wp_register_script( 'give_jquery_maskedinput', GIVE_FFM_PLUGIN_URL . 'assets/js/plugins/jquery-maskedinput' . $this->suffix . '.js', array( 'jquery' ) );
