...
<div class="card bg-primary">
    ...
    <div class="container-fluid bg-white fs-md py-3" id="end">
        ...
        <ul class="link-list horizontal justify-content-center mb-2" id="social-media">
            <li><a href="https://www.instagram.com/esrevenge/" target="blank" title="Instagram"><img class="rounded-circle"
                        src="<?php echo get_template_directory_uri(); ?>/images/btn-instagram.svg" alt="Instagram"></a></li>
            <li><a href="https://twitter.com/E_S_Revenge?lang=en" target="blank" title="Twitter"><img class="rounded-circle"
                        src="<?php echo get_template_directory_uri(); ?>/images/btn-twitter.svg" alt="Twitter"></a></li>
            <li><a href="https://www.facebook.com/EndangeredSpeciesRevenge" target="blank" title="Facebook"><img class="rounded-circle"
                        src="<?php echo get_template_directory_uri(); ?>/images/btn-facebook.svg" alt="Facebook"></a></li>
            <li><a href="https://www.youtube.com/channel/UCJWxTWqtD3w0839QsDDC8UQ" target="blank" title="Youtube"><img
                        class="rounded-circle" src="<?php echo get_template_directory_uri(); ?>/images/btn-youtube.svg" alt="YouTube"></a></li>
            <li><a href="https://www.linkedin.com/company/endangered-species-revenge-" target="blank" title="LinkedIn"><img
                        class="rounded-circle" src="<?php echo get_template_directory_uri(); ?>/images/btn-linkedin.svg"
                        alt="inkedIn"></a></li>
        </ul>
